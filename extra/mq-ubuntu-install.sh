...
if [ "$RUNNING_IN_DOCKER_BUILD" = true ]; then
    echo "Running in Docker build context. No sudo required for MQ environment setup."
...
exit 0    
    ...
    echo "Not running in Docker build context. Continuing with MQ environment setup."
